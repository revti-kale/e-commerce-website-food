      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
        <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
          ...
          <div className="absolute max-w-[400px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-4">
            ...
            <div className="bg-green-800 hover:bg-accent text-white rounded-full w-fit flex items-center gap-4 px-4 py-2 text-[14px] sm:px-6 sm:py-3 cursor-pointer">
        ...
        <div className="relative">
          ...
          <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-2">
            ...
            <div className="bg-green-800 hover:bg-accent text-white rounded-full w-fit flex items-center gap-4 px-4 py-2 text-[14px] cursor-pointer">
              Shop Now <BsArrowRight />
            </div>
          </div>
        </div>
